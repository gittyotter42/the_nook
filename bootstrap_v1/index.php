...
<div class = "row">
    <div class = "col-lg-12">
      <div class= "white-panel">
        ...
        <hr>
        <p>We are so glad you are here! The nook is safe, clean, and fun for children 0-6 years old. We offer a variety of party packages 
        fit for everyone's needs. Monthly memberships along with open play are available. Our play space 
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
      <div class= "white-panel">
        <h2 align = "center">Call to Book</h2>
        <hr>
        <h3 align = "center">(626) 202-3510</h3>
